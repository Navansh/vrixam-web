...
//   } 
  ...
  return (
        ...
        <nav className=' scroll-smooth ' id='navbar'>
          ...
          <div className='sm:flex sm:gap-5 md:flex md:gap-6'>
            ...
            <button onClick={clickhandler} className="lg:hidden text-white">
                ...
                <div className={`${toggle ? 'hidden' : 'block'}`}><RxHamburgerMenu className=' text-[30px]' /></div>
                {/* condition to show this only when toggle is true */}
                <div className={`${toggle ? 'block' : 'hidden'} text-[#ffffff] stroke-white`}>
    ...
    {/* condition to show this only when toggle is true */}
        <div className={`${toggle ? 'block' : 'hidden'} lg:hidden fixed z-50 top-[78px] w-full`}>
            <div className="bg-[#1A1A1A] flex flex-col items-center text-white">
                <a href='#' className='navlinks border-t-2 w-full h-[83px] flex flex-col items-center justify-center'>
                    <p className=' mb-0 '>WHAT WE DO</p>
                </a>
                ...
                <a href='#team' className='navlinks border-t-2 w-full h-[83px] flex flex-col items-center justify-center'>
                    OUR TEAM
                </a>
