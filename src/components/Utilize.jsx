  ...
  return (
    <div className=' w-full  cssutilize'>
        <div className=' flex mx-auto py-[70px] gap-9 max-w-[1440px]'>
            <div className=' max-w-[561px] flex flex-col gap-[14px] ml-[220px] mt-[50px]'>
                ...
                <p className=' font-PlusJakartaSans text-[15px] leading-[27px] mb-0'>We understand that when you make a donation, you want to know exactly where your money is going and we pledge to be transparent.</p>
