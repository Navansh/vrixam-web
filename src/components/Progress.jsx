...
const Progress = () => {
  return (
    <div className=' max-w-[1440px] justify-between mx-auto cssprogress flex sm:flex-col md:flex-col lg:flex-row gap-[100px]'>
        <div className=' flex flex-col sm:items-center md:items-center lg:ml-[6.75rem] lg:items-start md:max-w-[672px] md:mx-auto '>
            <p className=' font-NoeStandard sm:text-center md:text-left text-[36px] md:max-w-[400px] leading-[49px]'>Stepping up progress in <span className=' md:inline-block md:ml-[15px] lg:hidden'><br /></span> this defining decade</p>
        ...
        <div className=' flex sm:flex-col md:flex-row gap-9 max-w-[691px] md:mx-auto md:justify-center'>
