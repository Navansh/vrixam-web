  ...
  return (
    <div className=' max-w-[1440px] justify-between mx-auto cssprogress flex gap-[100px]'>
        <div className=' flex flex-col '>
            ...
            <p className=' font-PlusJakartaSans text-[15px] leading-[26px] text-[#2D2D2D] tracking-normal'>Our restoration projects aim to revitalize degraded lands, promote afforestation, reforestation, and rehabilitate ecosystems affected by human activities.</p>
        </div>
